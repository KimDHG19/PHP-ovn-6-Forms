...
<form action="PHP-6-tasks-1-5.php" method="post">
...
$monthNames = array('empty', 'Januari', 'Februari', 'Mars', 'April', 'Maj', 'Juni', 'Juli', 'Augusti', 'September', 'October', 'November', 'December');
